    ...
    <div class="container">
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div class="col-xs-12 col-sm-9  shadow">
                <div class="view-box">
                    <a class="btn btn-md btn-info" id="add">Add book</a>
                    ...
                    <br/>
                    <a class="btn btn-md btn-primary" id="more">More books</a>
                </div>
            </div>
        </div><!--/row-->
    </div><!--/container-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form class="form-horizontal" method="post" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="name" class="control-label col-xs-3">Title</label>
                    ...
                    <div class="form-group" hidden="hidden">
                        <label for="userName" class="control-label col-xs-3">Owner</label>
...
<script type="text/javascript" src="resources/js/bookDatatables.js"></script>
</html>
